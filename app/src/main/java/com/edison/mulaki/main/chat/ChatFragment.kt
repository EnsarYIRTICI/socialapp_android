package com.edison.mulaki.main.chat
...
import com.edison.mulaki.io.AndreyBreslav
...
import com.edison.mulaki.io.SocketKeys
import com.edison.mulaki.main.chat.adapter.BubbleAdapter
import com.edison.mulaki.main.chat.bottomsheet.GallerySheet
import com.edison.mulaki.main.chat.bottomsheet.PickerSheet
import com.edison.mulaki.main.chat.dialog.ProgressDialog
...
class ChatFragment: Fragment(){
    ...
    private fun showPickerSheet(){
        val bottomSheetFragment: PickerSheet = PickerSheet.instance(ID_ROOM, AUTH_UID)
        bottomSheetFragment.show(parentFragmentManager, "chatBottomSheet")
    }

    private fun showGallerySheet(ID_BUBBLE:String){
        try {
            val bottomSheetFragment: GallerySheet = GallerySheet.instance(itemList.toString(), ID_ROOM, ID_BUBBLE)
