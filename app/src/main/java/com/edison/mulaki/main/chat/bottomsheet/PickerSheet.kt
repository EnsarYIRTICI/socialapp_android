...
import com.edison.mulaki.main.chat.ChatFragment
import com.edison.mulaki.main.chat.ChatViewModel
...
class PickerSheet : BottomSheetDialogFragment() {
    ...
    companion object {
        ...
        fun instance( ID_ROOM: String, uid:String): PickerSheet {
            val fragment = PickerSheet()
            val args = Bundle()
