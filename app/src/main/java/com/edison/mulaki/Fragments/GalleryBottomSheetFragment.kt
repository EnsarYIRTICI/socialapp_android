...
import com.edison.mulaki.Adapters.ShowImageAdapter
...
class GalleryBottomSheetFragment: BottomSheetDialogFragment() {
    ...
    companion object {
        ...
        fun instance(result: String, ID_ROOM:String, ID_BUBBLE:String): GalleryBottomSheetFragment {
            val fragment = GalleryBottomSheetFragment()
            val args = Bundle()
